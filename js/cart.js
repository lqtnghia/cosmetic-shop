...
//Hàm thêm sự kiện thay đổi số lương cho ô nhập trong page info-product
// function updateCartForInfoProduct() {
//   const countChange = document.querySelectorAll(
//     ".product .foot-detail input[type='number']"
//   );
//   countChange.addEventListener("change", function () {
//     const valueNew = countChange.value;
//   });
//   const count = document.querySelector("form tbody input[type='number']");
//   btn.addEventListener("click", function () {
//     count.value = valueNew;
//   });
// }
